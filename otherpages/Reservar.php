<?php
    ...
    && isset($_POST['checkInDate']) && isset($_POST['checkOutDate'])) {
        ...
        $checkInDate = $_SESSION['checkInDate']; // Updated to get check-in date from session
        $checkOutDate = $_SESSION['checkOutDate']; // Updated to get check-out date from session
        ...
        $updateSql = "UPDATE Habitacion SET disponibilidad = 'No disponible' WHERE nombre = '$selectedRoomName'";
    ...
    <div class="reservation-form">
        ...
        <div class="availability">
            ...
            <?php
                ...
                echo "<p>te vas el dia: $checkInDate.</p>";
                echo "<p>y regresas el dia: $checkOutDate.</p>";
